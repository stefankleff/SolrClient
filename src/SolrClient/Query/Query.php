...
class Query implements \Serializable
{
    ...
    /**
     * Sets the maximum number of constraint counts that should be returned for
     * the facet fields
     *
     * @param int $limit
     * @return Query
    ...
    /**
     * Sets the minimum counts for facet fields should be included in the
     * response.
     *
     * @param int $count
     * @return Query
    ...
    /**
     * Gets the minimum counts for facet fields should be included in the
     * response.
     *
     * @return int
     */
